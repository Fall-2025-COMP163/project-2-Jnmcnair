...
class Player(Character):
    ...
    def display_stats(self):
        ...
        """
        super().display_stats()   # show base stats
        # Add player info
...
class Warrior(Player):
    ...
    def attack(self, target):
        ...
        print(f"{self.name} swings a heavy weapon for {damage} damage!")
        target.take_damage(damage)
    ...
    def power_strike(self, target):
        ...
        print(f"💥 {self.name} uses POWER STRIKE for {damage} massive damage!")
        target.take_damage(damage)
...
class Mage(Player):
    ...
    def fireball(self, target):
        ...
        """
        damage = self.magic + 10   # big spell damage
        print(f"🔥 {self.name} casts FIREBALL for {damage} massive damage!")
        target.take_damage(damage)
